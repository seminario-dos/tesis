...
%%%%%%%%%%%%%% Experimento 2
\subsection{Variando el intervalo de las invocaciones de redimensionamiento}
...
\begin{itemize}
    ...
    \item \emph{Carga de trabajo:}
    \begin{itemize}
        \item 50 invocaciones secuenciales de redimensionamiento de imágenes con dimensiones aleatorias a IM-XRay seguida de un tiempo de espera inicial de 10 minutos.
        \item Luego se ejecutará otra ráfaga de 100 invocaciones y se tendrá un tiempo de espera de 20 minutos.
        \item Se continuará aplicando la carga de trabajo anterior hasta que se logre observar algún cambio en la función.
    \end{itemize}
