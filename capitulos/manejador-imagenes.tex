...
\begin{axis}[
  ...
  xlabel={Tamaño de las imágenes (En $Kb$)},
...
\begin{axis}[
  ...
  title={Distribución de los tiempos de respuesta en solicitudes de\\ redimensionamiento de imágenes de tamaño $\leq 500Kb$ en IM-Simple},
  ylabel={Solicitudes de redimensionamiento},
  x label style={at={(axis description cs:0.5,-0.21)},anchor=north},
  xlabel={Tiempos de respuesta (En $ms$)},
...
%    title={Función de probabilidad acumulada en solicitudes de redimensionamiento de imágenes de tamaño $\leq 500Kb$ en \emph{Palladio Workbench}},
    xlabel={Segundos},
